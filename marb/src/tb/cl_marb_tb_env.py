...
class cl_marb_tb_env(uvm_env):
    ...
    Includes:
        - 3 CIF SDT Agents
        - 1 MIF SDT Agent
        - APB Agent (instantiated in base_test and attached to env)
        - Virtual Sequencer
        - Reference Model (A5)
        - Scoreboard (A6)
    """
    ...
    def build_phase(self):
        super().build_phase()
        self.logger.info("[BUILD] Building MARB Testbench Environment")

        # Retrieve configuration from Base Test
    ...
    def connect_phase(self):
        ...
        # Bind sequencers to virtual sequencer
        ...
        # CIF request_ap → Reference model
        for i, agent in enumerate(self.sdt_cif_agents):
        ...
        # APB monitor.ap → Reference model
        ...
        # MIF monitor.ap → Scoreboard and Coverage
        ...
        # Reference model → Scoreboard ref subscriber
